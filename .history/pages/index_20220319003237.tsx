          ...
          <div className={styles.ContentWrapper}>
            <div className={styles.Column}>
              ...
              <div className={styles.ColumnHeader}>
                ...
                <div>
                  <div className={styles.Selector}>
                    <div className={`${styles.Anchor} ${activeTab === "tab5" ? styles.active : ""}`} onClick={handleTab4}>
                      <h3>
                        <a>Streaming</a>
                      </h3>
                    </div>
                    <div className={`${styles.Anchor} ${activeTab === "tab6" ? styles.active : ""}`} onClick={handleTab4}>
                      <h3>
                        <a>On TV</a>
                      </h3>
                    </div>
